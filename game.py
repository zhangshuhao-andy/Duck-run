    ...
    while True:
        ...
        if lvl == 1 and state == "PLAY":
            ...
            if portal_x > 3200:
                ...
                msg = f.render("HOLD 'C' TO SLIDE UNDER LASERS", True, C_PINK)
                screen.blit(msg, (WIDTH//2 - msg.get_width()//2, 150))
...
m_btns = [AnimatedButton("START GAME", 350, 300, 300, 70, C_BTN, C_BTN_H),
          AnimatedButton("NEON SHOP", 350, 390, 300, 70, C_BTN, C_BTN_H),
          AnimatedButton("ABOUT", 350, 480, 300, 70, C_BTN, C_BTN_H)]
...
while True:
    ...
    if current_page == "MAIN_MENU":
        f = pygame.font.SysFont("Impact", 130).render("CYBER DUCK", True, C_GOLD)
        screen.blit(f, (WIDTH//2-f.get_width()//2, 120 + math.sin(t*0.005)*15))
        pygame.draw.line(screen, C_CYAN, (250, 280), (750, 280), 2)
